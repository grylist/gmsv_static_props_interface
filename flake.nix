{
  description = "Flake to build gmsv_static_props_interface";
    ...
    packages = forAllSystems (system: let
      ...
      in {
        crossPkgs = forEachSystem (lib.filter (sys: sys != system) allSystems) (targetSystem:
          ...
          in rec {
            gmsv_static_props_interface = crossPkgs.callPackage ./default.nix {};
            default = gmsv_static_props_interface;
          }
        );
      }
    );
